...
- `aipou-mcp-server@0.4.0` on npm with SLSA provenance, a disposable one-command demo, and protected persistent identity setup;
- `io.github.0xddneto/ai-proof-of-us@0.4.0` marked latest in the official MCP Registry;

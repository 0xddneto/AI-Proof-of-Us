...
- [follow-ups-2026-07-24.md](follow-ups-2026-07-24.md) records the A2A/Concordia confused-deputy feedback and the fail-closed artifact-verification response.
- [paybox-interoperability-2026-07-30.md](paybox-interoperability-2026-07-30.md) records the independent Paybox control-plane interoperability outreach and its explicit trust boundaries.
